...
class TsubasaFarmer extends BaseFarmer
{

    protected $key = 'tsubasa';
     ...
     */
    protected function getTsubasaApi(string $hash = '')
    {
        return $this->getBaseApi()->replaceHeaders([
            'X-Masterhash' => $hash,
            'X-Player-Id' => $this->farmer->user_id,
        ]);
    }
}